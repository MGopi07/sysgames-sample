            ...
            {globalSolutions.map((solution) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center p-4 rounded-xl text-left transition-all duration-300 ${isActive ? "bg-white/5" : "hover:bg-white/5"
                    }`}
                >
                  <div className={`absolute left-[-2px] w-1 h-8 rounded-r-full transition-all duration-300 ${isActive ? "bg-[var(--primary)] opacity-100" : "bg-transparent opacity-0"
                    }`}></div>

                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center mr-4 transition-colors duration-300 ${isActive ? "bg-gradient-accent text-white shadow-[0_0_15px_rgba(var(--secondary-rgb),0.5)]" : "bg-white/5 text-gray-400 border border-white/10"
                    }`}>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center gap-5 mb-10 pb-8 border-b border-white/10 relative">
                  ...
                  <div className="text-white bg-gradient-accent p-4 rounded-2xl shadow-[0_0_30px_rgba(var(--primary-rgb),0.3)]">
